...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person richPerson = new Person("rich person",1000);
        Person poorPerson = new Person("poor person", 1);
        
        System.out.println(richPerson.compareTo(poorPerson));
        System.out.println(poorPerson.compareTo(richPerson));
